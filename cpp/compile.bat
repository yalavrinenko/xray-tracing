...
for %%x in (*.cpp) do gcc.exe -m32 -O2 -D__USE_MINGW_ANSI_STDIO -D WIN32 -D NO_OMP_SUPP -D M_PI=3.14159265358979 -fPIC -fopenmp -c -std=gnu++11 -w %%x -o %dirname_32%/%%x.o
...
for %%x in (*.cpp) do gcc.exe -m64 -O2 -D__USE_MINGW_ANSI_STDIO -D WIN32 -D M_PI=3.14159265358979 -fPIC -fopenmp -c -std=c++11 -w %%x -o %dirname_64%/%%x.o
