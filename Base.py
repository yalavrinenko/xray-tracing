...
class spGeneral:
    ...
    def updWaveLength(self):
        ...
        self.sys.setWaveLength(toAdd, toAddInt, toAddWw)
    ...
    def on_button1_clicked(self,obj):        
        ...
        if (self.isCentralLineSelected):
            [w1,w2]=self.sys.calcLimWaveLength(int(self.entry_zeroOrder.get_text()))
    ...
    def on_button2_clicked(self,obj):
        ...
        #self.sys.SlitPos=float(self.slitPos.get_text())
        #self.sys.SlitH = float(self.slitSizeH.get_text())
        #self.sys.SlitW = float(self.slitSizeW.get_text())
    ...
    def on_entry7_changed(self,obj):   
        ...
        if (not self.sys.isCompute == 0):
            ...
            if (not len(list) == 0):
                self.sys.resPlot.plotFilm(list, self.sys.zeroWave, self.sys.WaveLengths, self.sys.crystal2d, Orders, order)
    ...
    def on_button5_clicked(self,obj):
        ...
        #self.sys.WaveLengths+=[round(float(self.MinWl[0].get_text()),4)]
        #self.sys.WaveLengths+=[round(float(self.MaxWl[0].get_text()),4)]
    ...
    def initWindow(self):
        ...
        #self.wResAx = self.wResFig.add_subplot(111)
